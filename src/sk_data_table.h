...
public:
     ...
     */
    static SkDataTable* MakeCopyArrays(const void * const * ptrs,
     ...
     */
    static SkDataTable* MakeCopyArray(const void* array, size_t elemSize, int count);

    static SkDataTable* MakeArrayProc(const void* array, size_t elemSize, int count,
