...
extern void* sk_calloc_throw(size_t count, size_t elemSize);
extern void* sk_malloc_throw(size_t count, size_t elemSize);
extern void* sk_realloc_throw(void* buffer, size_t count, size_t elemSize);
